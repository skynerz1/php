  ...
  ob_start();
  ##########
  $token = "5208836869:AAGElGdI6NoWvjY1H2Zn6dzSM9g6S6mJXtQ"; // توكنك
  $kindi = "5208836869:AAGElGdI6NoWvjY1H2Zn6dzSM9g6S6mJXtQ";// توكنك

  $buy = "wgggk";
  $userbot ="Sourcefnbot";
  $sudo = "1965941065"; // ايديك
  $admin = "$sudo";
  $idBot = "5208836869";// ايدي بوتك
  $admmm = $sudo;
  $ADMIN = $sudo;
  $Dev = array("$sudo","1965941065");// ايديك
  $Devd = "$sudo";
  $tbbots = "Sourcefnbot";/// يوزر بوتك بدون @
  
  $channel = "a8sam1";/// يوزر قناتك بدون@
  $chinnl = "$channel";
  $DevUser = "@$buy"; // 
  $Devch = "@$buy"; //  
  $Userbot = "$tbbots"; // 
